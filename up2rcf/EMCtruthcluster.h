#ifndef EMCtruthcluster_H
#define EMCtruthcluster_H
...
class EMCtruthcluster : public SubsysReco
{
 public:

  EMCtruthcluster(const std::string &name = "EMCtruthcluster", const std::string &file = "output.root");

  ~EMCtruthcluster() override;
 ...
 private:
   ...
   std::vector<float> _CEMC_Hit_pid;
